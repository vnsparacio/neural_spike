...
int main(int argc, char *argv[])
{
    ...
    int block_peak_count[20];
    int block2_peak_count[20];

    int peak_analysis[buf_size]; //buffer for peak analysis of input0
    int peak_analysis2[buf_size]; //buffer for peak analysis of input1 
